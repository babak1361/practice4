...
9. Create a new branch called `tc001`
10. Create a new class called `TestCase001` and make a commit with proper commit message
11. Add 3 more changes and make 3 more individual commits
12. And now merge your commits into master branch
 */